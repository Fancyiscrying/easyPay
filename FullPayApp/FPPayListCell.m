...
@property (nonatomic, weak) FPPayListCell *parentCell;
@property (nonatomic) SEL utilityButtonSelector;

- (id)initWithUtilityButtons:(NSArray *)utilityButtons parentCell:(FPPayListCell *)parentCell utilityButtonSelector:(SEL)utilityButtonSelector;

- (id)initWithFrame:(CGRect)frame utilityButtons:(NSArray *)utilityButtons parentCell:(FPPayListCell *)parentCell utilityButtonSelector:(SEL)utilityButtonSelector;
...
@interface FPPayListCell () <UIScrollViewDelegate>
{
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier containingTableView:(UITableView *)containingTableView leftUtilityButtons:(NSArray *)leftUtilityButtons rightUtilityButtons:(NSArray *)rightUtilityButtons {
    ...
    if (self) {
        ...
        self.height = containingTableView.rowHeight+15;
...
- (void)initializer {
    ...
    UILongPressGestureRecognizer *longGestureRecognizer = [[UILongPressGestureRecognizer alloc]initWithTarget:self action:@selector(scrollViewLongPressed:)];
    [cellScrollView addGestureRecognizer:longGestureRecognizer];
...
- (void)scrollViewLongPressed:(UIGestureRecognizer *)sender {
