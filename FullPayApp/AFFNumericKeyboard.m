...
- (void)setSpecialButtonEnable:(BOOL)enable
{
    UIButton *btnSpecial = (UIButton *)[self viewWithTag:10];
    [btnSpecial setEnabled:enable];
    if (enable) {
        UIColor *colorNormal = [UIColor colorWithRed:252/255.0 green:252/255.0 blue:252/255.0 alpha:1];
        btnSpecial.backgroundColor = colorNormal;
    } else {
        UIColor *colorHightlighted = [UIColor colorWithRed:186.0/255 green:189.0/255 blue:194.0/255 alpha:1.0];
        btnSpecial.backgroundColor = colorHightlighted;
    }
}
