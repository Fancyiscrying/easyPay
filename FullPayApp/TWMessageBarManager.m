...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([self.delegate respondsToSelector:@selector(styleSheetForMessageView:)])
    {
        ...
        NSDictionary    *attributes = @{NSFontAttributeName:kTWMessageViewTitleFont};
...
//        [self.titleString drawInRect:CGRectMake(xOffset, yOffset, titleLabelSize.width, titleLabelSize.height) withFont:kTWMessageViewTitleFont lineBreakMode:NSLineBreakByTruncatingTail alignment:NSTextAlignmentLeft];
        ...
        NSDictionary    *attributes1 = @{NSFontAttributeName:kTWMessageViewDescriptionFont};
        [self.descriptionString drawInRect:CGRectMake(xOffset, yOffset, descriptionLabelSize.width, descriptionLabelSize.height) withAttributes:attributes1];
